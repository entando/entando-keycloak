    ...
    <div class="LoginPage">
      <div class="LoginPage__formWrapper">
        <div class="LoginPage__brand">
          ...
          <div class="LoginPage__description">
            ${msg("entandoUxBrandDescription")}
          </div>
        </div>
        <#nested "form">
          <#assign aDateTime=.now>
            <#assign aDate=aDateTime?date>
              <div class="LoginPage__copyright">
                ${msg("copyright")} ${aDate?string.yyyy}
                <a href="https://www.entando.com/" class="LoginPage__url">Entando</a>
              </div>
      </div>
    </div>
  </body>
